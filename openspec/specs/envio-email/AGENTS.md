# AGENTS.md — Spec Envío por Email

## Propósito

Spec de envío de certificados por email.
...
| Docs relacionados | Necesitas contexto de email/PDF | `docs/pdf-qr/00-pdf-qr-certificado.md` |
