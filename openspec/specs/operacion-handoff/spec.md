...
El MVP debe entregarse con documentación suficiente para que el equipo pueda mostrar, usar, mantener y explicar el prototipo del sistema de certificaciones QR.

## Alcance

Incluye:

- guía de usuario para Bedelía;
- guía breve para Rectorado;
- guía técnica para mantenedor;
- checklist de handoff;
- guía de soporte básico;
- documentación de credenciales, backups y privacidad;
- roadmap post-MVP;
- plan de integración futura con la web institucional.

## Fuera de alcance

- integración real con la web oficial;
- guía completa de producción institucional;
...
- La documentación separa MVP de etapa futura.
- La integración web institucional queda como post-MVP.
- El checklist de handoff cubre producto, deploy, seguridad y documentación.
- La documentación mantiene español argentino formal.
...
- Confirmar proveedor real de email o modo simulado.
- Confirmar si habrá guía entregable en PDF.
- Confirmar responsables institucionales post-demo.
- Confirmar fecha de etapa 2.